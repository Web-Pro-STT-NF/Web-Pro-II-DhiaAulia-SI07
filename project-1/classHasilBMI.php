        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
              <form action='classHasilBMI.php' method='POST'>
...
$ps1 = new Pasien();
$ps1->kode = 'U045';
$ps1->nama = 'Muhammad Abdul';
$ps1->gender = 'Laki-laki';

$ps2 = new Pasien();
$ps2->kode = 'U032';
$ps2->nama = 'Annisa Assyifa';
$ps2->gender = 'Perempuan';

$ps3 = new Pasien();
$ps3->kode = 'U077';
$ps3->nama = 'Zakiyah Nabilla';
$ps3->gender = 'Perempuan';

$ps4 = new Pasien();
$ps4->kode = $_POST['kode'];
$ps4->nama = $_POST['text'];
$ps4->gender = $_POST['checkbox'];
...
$bp1 = new BMIPasien($bmi1, '2022-02-02', $ps1);
$bp2 = new BMIPasien($bmi2, '2022-03-05', $ps2);
$bp3 = new BMIPasien($bmi3, '2022-05-15', $ps3);
